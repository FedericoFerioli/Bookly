...
<div>
    <p>Dati personali</p>
    <h1>Nome: <?= $userData['name'] ?? 'Dato mancante' ?></h1>
    <h1>Cognome: <?= $userData['surname'] ?? 'Dato mancante' ?></h1>
    <h1>Genere: <?= $userData['gender'] ?? 'Dato mancante' ?></h1>
    <h1>Email: <?= $userData['email'] ?? 'Dato mancante' ?></h1>
    <h1>Email: <?= $userData['dob'] ?? 'Dato mancante' ?></h1>
</div>
